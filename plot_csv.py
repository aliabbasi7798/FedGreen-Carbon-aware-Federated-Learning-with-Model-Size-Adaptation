...
if __name__ == "__main__":
    ...
    with open('FedGreenCS/Emnist_E=1_alpha=0.01_feq1_real_m=1_sd=0_gc=1_kc=10_b=n.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
    ...
    with open('FedGreenCS/Emnist_E=1_alpha=0.01_feq1_real_m=0.6_sd=0_gc=1_kc=10_b=n.csv', 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
    ...
    plt.plot(z3, y3, color='g', label='3 cluster m= 0.6, sd=0.32', linewidth=0.7)
    plt.plot(z4, y4, color='m', label='FedGreenCS, m=0.6 , sd=0.32, k-mean-cluster=10', linewidth=0.7)

    plt.plot(z5, y5, color='b', label='FedGreenCS, m=1 , k-mean-cluster=10', linewidth=0.7)
    plt.plot(z6, y6, color='y', label='FedGreenCS, m=0.6 , k-mean-cluster=10', linewidth=0.7)

    plt.legend()
    plt.ylabel('test accuracy')
    plt.xlabel('Carbon Cost')
    plt.savefig('FedGreenCS_plot/alpha=0.01_clientselection_E=1_round_CS_total_3cluster_b_k=10.pdf')